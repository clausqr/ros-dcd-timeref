...
> **TL;DR**: Convert **Sensor Trigger Pulse → DCD** into **/dev/ppsX** (`pps_ldisc`), and publish exact trigger timestamps as `sensor_msgs/TimeReference`. **Corrects USB-serial jitter and lag** by using direct RS-232/RS-485 hardware sync.
